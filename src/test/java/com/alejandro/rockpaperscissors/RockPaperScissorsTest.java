...
public class RockPaperScissorsTest {
    ...
    @Test
    void GivenIHaveChosenLizardWhenTheOpponentChoosesPaperThenIShouldWin() {
        var playerChoose = Moves.LIZARD;
    ...
    @Test
    void GivenIHaveChosenScissorsWhenTheOpponentChoosesLizardThenIShouldWin() {
        var playerChoose = Moves.SCISSORS;
        var opponent = Moves.LIZARD;
    ...
    @Test
    void GivenIHaveChosenLizardWhenTheOpponentChoosesScissorsTheOpponentShouldWin() {
        var playerChoose = Moves.LIZARD;
        var opponent = Moves.SCISSORS;
    ...
    @Test
    void GivenIHaveChosenLizardWhenTheOpponentChoosesLizardThenItShouldBeADraw() {
        var playerChoose = Moves.LIZARD;
        var opponent = Moves.LIZARD;
